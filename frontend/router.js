...
if (require.main === module) {
    ...
    if (translatePath("neuviz/1.0/data/2013/01/") !== undefined) {
        console.error("router: return something with wrong 0th param");
        process.exit(1);
    }

    if (translatePath("/foobar/1.0/data/2013/01/") !== undefined) {
        console.error("router: return something with wrong 1st param");
        process.exit(1);
    }

    if (translatePath("/neuviz/foobar/data/2013/01/") !== undefined) {
        console.error("router: return something with wrong 2nd param");
        process.exit(1);
    }

    if (translatePath("/neuviz/1.0/foobar42/2013/01/") !== undefined) {
        console.error("router: return something with wrong 3th param");
        process.exit(1);
    }

    if (translatePath("/neuviz/1.0/data/foobar/01/") !== undefined) {
        console.error("router: return something with wrong 4th param");
        process.exit(1);
    }

    if (translatePath("/neuviz/1.0/data/2013/foobar/") !== undefined) {
